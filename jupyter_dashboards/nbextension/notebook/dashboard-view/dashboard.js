...
define([
    ...
    var gridControlsTpl =
        ...
        '<div class="grid-control-container grid-control-ne">' +
            ...
            '<span class="grid-control add-btn add-btn-relative fa-fw" title="Add to the dashboard according to its position in the notebook">' +
            ...
            '</span>' +
            '<span class="grid-control add-btn add-btn-top fa-fw" title="Add to the top of the dashboard">' +
                '<span class="bar-container">' +
                    '<span class="bar"></span>' +
                    '<span class="bar bar-lighter"></span>' +
                    '<span class="bar bar-lighter"></span>' +
                ...
                '<i class="fa fa-plus"></i>' +
            '</span>' +
            '<span class="grid-control add-btn add-btn-bottom fa-fw" title="Add to the bottom of the dashboard">' +
                '<span class="bar-container">' +
                    '<span class="bar bar-lighter"></span>' +
                    '<span class="bar bar-lighter"></span>' +
                    '<span class="bar"></span>' +
    ...
    Dashboard.prototype._addGridControls = function($cell) {
        ...
        if ($cell.find('.grid-control-nw').length === 0) {
            ...
            gc.find('.add-btn-relative').click(function() {
                    ...
                    var i = $cell.index();
                    var $prevCell = $cell.parent()
                        .find('.cell')
                        .slice(0,i)
                        .filter('.grid-stack-item')
                        .last();
